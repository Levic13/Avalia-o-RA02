...
public class Binario {
    public static void main(String[] args) {
        ...
        for (int tamanho : tamanhos) {
            ...
            long inicioCriacao = System.nanoTime();
            ...
            long tempoCriacao = fimCriacao - inicioCriacao;
            ...
            // 10 remoções aleatórias
            long inicioRemocoes = System.nanoTime();

            for (int i = 0; i < 10; i++) {
                int valorRemocao = random.nextInt(1000);
                arvore.remover(valorRemocao);
            }

            long fimRemocoes = System.nanoTime();
            long tempoRemocoes = fimRemocoes - inicioRemocoes;
            ...
            System.out.println("Tempo de inserção para " + tamanho + " elementos: " + tempoCriacao + " ns");
            System.out.println("Tempo para realizar 100 buscas aleatórias: " + tempoBuscas + " ns");
            System.out.println("Tempo para realizar 10 remoções aleatórias: " + tempoRemocoes + " ns");
